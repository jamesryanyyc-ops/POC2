           ...
           <div className="space-y-4">
             ...
             <div className="flex items-center gap-3 w-full cursor-pointer group">
               ...
               <div className="h-11 w-11 flex-shrink-0">
                 <img src="https://picsum.photos/seed/notif1/100/100" alt="Post" className="h-full w-full object-cover rounded-md cursor-pointer hover:opacity-80 transition-opacity" />
               </div>
             </div>
             ...
             <div className="flex items-center gap-3 w-full cursor-pointer group">
               ...
               <div className="h-11 w-11 flex-shrink-0">
                 <img src="https://picsum.photos/seed/notif2/100/100" alt="Post" className="h-full w-full object-cover rounded-md cursor-pointer hover:opacity-80 transition-opacity" />
               </div>
             </div>
